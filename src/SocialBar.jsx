...
const SocialBar = () => {
    return (
        <div className='hidden md:block'>
            ...
            <div className="fixed bottom-12 md:bottom-0 left-4 flex flex-col md:flex-col items-start md:items-center gap-3 z-50 text-white text-2xl">
            ...
            {/* Right Side Email */}
            <div className="fixed bottom-4 left-4 md:bottom-0 md:right-6 flex md:flex-col items-start md:items-end gap-3 z-50 text-white text-sm">
